# Generated by Django 3.1.1 on 2021-03-11 04:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('crams_compute', '0002_init_lookups'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archive_ts', models.DateTimeField(blank=True, null=True)),
                ('question_response', models.TextField(blank=True, max_length=1024)),
                ('compute_request', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='compute_request_responses', to='crams_allocation.computerequest')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='compute_allocation_responses', to='crams.question')),
            ],
        ),
        migrations.AddField(
