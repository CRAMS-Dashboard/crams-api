...
from crams_allocation_review import models as review_models
from crams_allocation_review.serializers import ReviewSerializer
from crams_allocation_review import utils
...
class ReviewSendView(CreateModelMixin,
    ...
    def _send_email(self, review_date, erb):
        # TODO: this part will be later updated to use the rabbit mq thingy
        ...
        # sender and reply_to get from conf using erb
        sender = config_init.eSYSTEM_REPLY_TO_EMAIL_MAP.get(
        ...
        try:
            ...
            # TODO: record should be marked 'Failed'?
            raise exceptions.ParseError(
                "email send failed for review id - ".format(review_date.id))
