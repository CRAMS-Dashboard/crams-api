...
"""
from crams_demo.config.config_init import RDSM_ERB_LOWER, RDSM_ERB_SYSTEM_LOWER
...
from crams_demo.notifications.software import send_software_notification
...
EXTEND_ON_QUOTA_CHANGE.append(RDSM_ERB_SYSTEM_LOWER)


fn_key = (RDSM_ERB_SYSTEM_LOWER, RDSM_ERB_LOWER)
...
ERB_Software_Email_fn_dict[RDSM_ERB_LOWER] = send_software_notification
