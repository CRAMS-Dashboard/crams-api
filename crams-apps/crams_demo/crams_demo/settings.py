"""
Django settings for crams_demo project.
...
WSGI_APPLICATION = 'crams_demo.wsgi.application'
...
try:
    from crams_demo.local.local_settings import *  # noqa
except ImportError:
