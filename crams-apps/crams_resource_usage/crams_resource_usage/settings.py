...
ROOT_URLCONF = 'crams_resource_usage.urls'
...
WSGI_APPLICATION = 'crams_resource_usage.wsgi.application'
...
try:
    from crams_resource_usage.local.local_settings import *  # noqa
except ImportError:
